...
def list_files(set_number, seq_number):
    files = glob.glob('caltech/images/set{:02d}/V{:03d}.seq/*.jpg'.format(set_number, seq_number))
    random.shuffle(files)
    return files

def show_image(set_number, seq_number, frame_number, annotations = None):
    image = Image.open('caltech/images/set{:02d}/V{:03d}.seq/{}.jpg'.format(set_number, seq_number, frame_number))
...
def parse_annotations():
    with open('caltech/annotations.json') as json_file:
